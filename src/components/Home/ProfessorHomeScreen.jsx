...
export default function ProfessorHomeScreen() {
  ...
  function goReserveProduct() {
    navigate('/professorMypage'); //로그인 되었을 경우
  }
  ...
  function goSetProduct() {
    navigate('/professor/counsel');
  }
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.homemenu}>
        <button className={styles.btn2} onClick={goReserveProduct}>
          상담 예약 확인하기
        </button>
        <button className={styles.btn3} onClick={goSetProduct}>
          <BsPersonCheck size={30} />
          <div className={styles.btndiv}>
            <span>상담 시간 설정하기</span>
          </div>
        </button>
